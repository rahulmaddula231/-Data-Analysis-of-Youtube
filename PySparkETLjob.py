...
## @return: datasource0
## @inputs: []
## To overcome the different language, we are just filtering the English used regions
...
d = dropnullfields3.toDF().coalesce(1)
dataframe = DynamicFrame.fromDF(d, glueContext, "dataframe")
dasin = glueContext.write_dynamic_frame.from_options(frame = dataframe, connection_type = "s3", connection_options = {"path": "s3://youtubeproject/youtube/raw_statistics/", "partitionKeys": ["region"]}, format = "parquet", transformation_ctx = "datasink4")
job.commit()
